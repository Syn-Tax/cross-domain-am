...
ARGUMENT_MAP_PATH = f"data/Moral Maze/GreenBelt/argument_map.json"
AUDIO_PATH = f"raw_data/Moral Maze/GreenBelt/audio_16000.mp3"

OUT_PATH = f"data/Moral Maze/GreenBelt/audio/"
